...
public class JsonUtility {
	...
	/*public static boolean javaObjectToJsonFile(Object className, String location)
		...
		try {
			...
			throw new JsonGenerationException(JsonUtilConstants.ANAR_JSON_GENERATION_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.ANAR_JSON_GENERATION_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (com.fasterxml.jackson.databind.JsonMappingException e) {
			throw new JsonMappingException(JsonUtilConstants.ANAR_JSON_MAPPING_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.ANAR_JSON_MAPPING_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (java.io.IOException e) {
			throw new IOException(JsonUtilConstants.ANAR_IO_EXCEPTION_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.ANAR_IO_EXCEPTION_ERROR_CODE.getErrorMessage(), e.getCause());
		}
		return (file.exists());
	...
	public static String javaObjectToJsonString(Object className) throws JsonProcessingException {
		...
		try {
			...
			throw new JsonProcessingException(JsonUtilConstants.ANAR_JSON_PROCESSING_EXCEPTION.getErrorCode(),
					JsonUtilConstants.ANAR_JSON_PROCESSING_EXCEPTION.getErrorMessage(), e.getCause());
		}
	...
	public static Object jsonStringToJavaObject(Class<?> className, String jsonString)
		...
		try {
			...
			throw new JsonParseException(JsonUtilConstants.ANAR_JSON_PARSE_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.ANAR_JSON_PARSE_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (com.fasterxml.jackson.databind.JsonMappingException e) {
			throw new JsonMappingException(JsonUtilConstants.ANAR_JSON_MAPPING_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.ANAR_JSON_MAPPING_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (java.io.IOException e) {
